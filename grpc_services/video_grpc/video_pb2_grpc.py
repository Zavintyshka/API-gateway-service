...
from grpc_services.video_grpc import video_pb2 as video__pb2
...
class VideoServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessVideo = channel.stream_stream(
            ...
            response_deserializer=video__pb2.ProcessedVideoResponse.FromString,
...
def add_VideoServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        'ProcessVideo': grpc.stream_stream_rpc_method_handler(
            ...
            response_serializer=video__pb2.ProcessedVideoResponse.SerializeToString,
        ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
        'video_service.VideoService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('video_service.VideoService', rpc_method_handlers)
...
class VideoService(object):
    ...
    def ProcessVideo(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            video__pb2.ProcessedVideoResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
